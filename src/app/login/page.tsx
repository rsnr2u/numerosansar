        ...
        <div className="min-h-screen flex items-stretch bg-white font-['Inter',_sans-serif]">
            ...
            <section className="hidden lg:flex w-1/2 relative bg-[#4B2E83] overflow-hidden flex-col justify-center px-20 text-white">
                ...
                <div className="absolute bottom-12 left-20">
                    <p className="text-sm font-bold opacity-30 tracking-widest uppercase">© {config?.platform_name?.toUpperCase() || 'NUMERO SANSAR'}</p>
                </div>
            </section>
            ...
            <section className="flex-1 flex flex-col justify-center items-center px-6 bg-slate-50 relative overflow-hidden">
                ...
                >
                    ...
                    <div className="lg:hidden mb-12 text-center space-y-2">
                        ...
                        <h2 className="text-2xl font-black text-[#4B2E83]">{config?.platform_name?.toUpperCase() || 'NUMERO SANSAR'}</h2>
                    </div>
                    ...
                    <div className="mt-10 text-center space-y-6">
                        <p className="text-slate-400 font-bold text-sm">
                            New to {config?.platform_name?.toUpperCase() || 'NUMERO SANSAR'}?
                        </p>
                    ...
                    <div className="lg:hidden mt-20 text-center">
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">© {config?.platform_name?.toUpperCase() || 'NUMERO SANSAR'}</p>
                    </div>
                </motion.div>
            </section>
        </div>
