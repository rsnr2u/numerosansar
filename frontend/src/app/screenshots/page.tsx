    ...
    const sections = [
        {
            ...
            description: "The NUMERO SANSAR dashboard allows numerologists to manage client profiles, track consultations, and perform numerology analysis from a single workspace.",
                    ...
                    <div className="max-w-4xl mx-auto space-y-6 relative">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-[#4B2E83] leading-tight">
                                See <span className="text-[#C9A227]">NUMERO SANSAR</span> in Action
                            </h1>
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed font-medium">
                                    The NUMERO SANSAR dashboard allows numerologists to manage client profiles, track consultations, and perform numerology analysis from a single workspace.
                                </p>
                            </div>
                                ...
                                <div className="aspect-[16/10] bg-white rounded-[1.5rem] border border-slate-200 flex items-center justify-center overflow-hidden relative group">
                                    ...
                                    <div className="absolute top-0 left-0 w-full h-12 bg-slate-50 border-b border-slate-200 flex items-center px-4 gap-2">
                                        ...
                                        <div className="mx-auto w-1/3 h-6 bg-white border border-slate-200 rounded-md shadow-sm flex items-center justify-center">
                                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">dashboard.numerosansar.com</span>
                                        </div>
                                    </div>
